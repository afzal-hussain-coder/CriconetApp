...
public class AcademyBookingDetailsActivity extends AppCompatActivity {
    ...
    String valid_for="",address,TrainingType="";
    TextView tvSessionTime,tvAddress,tv_training;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_academy_booking_details2);
        mActivity = this;
        ...
        fl_book_another_session.setOnClickListener(v -> {
            startActivity(new Intent(AcademyBookingDetailsActivity.this, MainActivity.class).putExtra("type", "academyFragment").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
            finish();
        });
        fl_navigate_home_page = findViewById(R.id.fl_navigate_home_page);
        fl_navigate_home_page.setOnClickListener(v -> {
            startActivity(new Intent(AcademyBookingDetailsActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
            finish();
        });
        ...
        if (bundle != null) {
            ...
            if (fromWhere.equalsIgnoreCase("1")) {
                valid_for = bundle.getString("VALID");
                address = bundle.getString("Address");
                TrainingType=bundle.getString("TrainingType");
                tvAddress.setText(address);
                tv_training.setText(getString(R.string.training_type)+" "+TrainingType);
    ...
    private void bookingDetails(BookingPaymentsDetails bookingPaymentsDetails) {
        ...
        try {
            ...
            tvSessionDetails.setText(bookingPaymentsDetails.getBooking_id());
          //  tvSessionDateTime.setText(Global.convertUTCDateToLocalDate(bookingPaymentsDetails.getOnlineSessionStartTime()) + " , " + bookingPaymentsDetails.getBookingSlotTxt());
            tvSessionTime.setText(bookingPaymentsDetails.getBookingSlotTxt());
            tvSessionDateTime.setText(getString(R.string.valid_for) +" "+valid_for);
    ...
    private void cancelAlertDialog() {
        final Dialog dialog = new Dialog(AcademyBookingDetailsActivity.this);
        ...
        fl_yes.setOnClickListener(v -> {
            dialog.dismiss();
            startActivity(new Intent(AcademyBookingDetailsActivity.this, CancellationFeedbackFormActivity.class).putExtra("BookingId", bookingId));
        });
        dialog.show();
    }
