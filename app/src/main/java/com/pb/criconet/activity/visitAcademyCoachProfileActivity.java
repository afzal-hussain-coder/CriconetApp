...
public class visitAcademyCoachProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academy_coatch_profile);
        mContext = this;
    ...
    private void getIntentValue() {
        ...
        if (extras != null) {
            ...
            ArrayList<AcademyListModel.AcademyCoaches.certificate> object = (ArrayList<AcademyListModel.AcademyCoaches.certificate>) args.getSerializable("ARRAYLIST");
            //Toaster.customToast(object.isEmpty()+"");
            if (object.isEmpty()) {
                rl_certificate.setVisibility(View.GONE);
            } else {
                Bundle argss = getIntent().getBundleExtra("Certificate");
                ArrayList<AcademyListModel.AcademyCoaches.certificate> objectt = (ArrayList<AcademyListModel.AcademyCoaches.certificate>) argss.getSerializable("ARRAYLIST");
                //CoachList.certificate certificate = objectt.get(0);
                Glide.with(mContext).load(objectt.get(0).getCertificate_url())
                            .into(img_certificate);
                    img_certificate.setOnClickListener(v -> {
                        imageViewDialog(objectt.get(0).getCertificate_url());
                    });
...
//            }
            if (extras.getString("lang").isEmpty() || extras.getString("lang").equalsIgnoreCase("null")) {
                rel_language.setVisibility(View.GONE);
            } else {
                rel_language.setVisibility(View.VISIBLE);
            ...
            if (extras.getString("achievementDetails").isEmpty() || extras.getString("achievementDetails").equalsIgnoreCase("null")) {
            ...
            if (extras.getString("what_you_teach").isEmpty() || extras.getString("what_you_teach").equalsIgnoreCase("null")) {
            ...
            if (extras.getString("skills_you_learn").isEmpty() || extras.getString("skills_you_learn").equalsIgnoreCase("null")) {
            ...
            if (extras.getString("des").isEmpty() || extras.getString("des").equalsIgnoreCase("null")) {
            ...
            tvBookNow.setOnClickListener(v -> {
                ...
                if (extras.getInt("rating") == 0) {
                    ...
                    intent.putExtra("rating", extras.getInt("rating"));
                }
