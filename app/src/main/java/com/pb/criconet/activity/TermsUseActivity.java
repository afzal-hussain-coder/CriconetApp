    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TermsUseActivity.this, Signup.class);
                startActivity(intent);
                finish();
            }
        });
        queue = Volley.newRequestQueue(TermsUseActivity.this);
        ...
        progress = new ProgressDialog(TermsUseActivity.this);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObject.optString("api_text").equalsIgnoreCase("Success")) {
                                ...
                                mTitle.setText(Global.capitizeString(jsonObject.optString("title")));
