...
public class FilterCoachSelectionDropDownView extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private FilterCoachSelectionDropDownView.onClickInterface onClickInterface;

    public FilterCoachSelectionDropDownView(Context context) {
        super(context);
        initView();
    }

    public FilterCoachSelectionDropDownView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public FilterCoachSelectionDropDownView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        FilterCoachSelectionDropDownView.CustomAdapter adapter = new FilterCoachSelectionDropDownView.CustomAdapter(optionList,context);
    ...
    public void setClickListener(FilterCoachSelectionDropDownView.onClickInterface listener) {
    ...
    public class CustomAdapter extends ArrayAdapter<DataModel> implements OnClickListener {
        ...
        CustomAdapter(ArrayList<DataModel> data, Context context) {
            super(context, R.layout.filter_coach_spinner_item, data);
            this.dataSet = data;
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            FilterCoachSelectionDropDownView.CustomAdapter.ViewHolder viewHolder; // view lookup cache stored in tag
            if (convertView == null) {
                ...
                viewHolder = (FilterCoachSelectionDropDownView.CustomAdapter.ViewHolder) convertView.getTag();
            }
