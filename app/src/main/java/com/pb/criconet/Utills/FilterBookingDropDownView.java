...
public class FilterBookingDropDownView extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private FilterBookingDropDownView.onClickInterface onClickInterface;

    public FilterBookingDropDownView(Context context) {
        super(context);
        initView();
    }

    public FilterBookingDropDownView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public FilterBookingDropDownView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        FilterBookingDropDownView.CustomAdapter adapter = new FilterBookingDropDownView.CustomAdapter(optionList,context);
    ...
    public void setClickListener(FilterBookingDropDownView.onClickInterface listener) {
    ...
    public class CustomAdapter extends ArrayAdapter<DataModel> implements OnClickListener {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            FilterBookingDropDownView.CustomAdapter.ViewHolder viewHolder; // view lookup cache stored in tag
            if (convertView == null) {
                viewHolder = new FilterBookingDropDownView.CustomAdapter.ViewHolder();
                ...
                viewHolder = (FilterBookingDropDownView.CustomAdapter.ViewHolder) convertView.getTag();
            }
