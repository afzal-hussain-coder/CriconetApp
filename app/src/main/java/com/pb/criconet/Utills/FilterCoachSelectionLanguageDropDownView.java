...
public class FilterCoachSelectionLanguageDropDownView extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {

    private ArrayList<DataModel> optionList = new ArrayList<>();
    private FilterCoachSelectionLanguageDropDownView.onClickInterface onClickInterface;

    public FilterCoachSelectionLanguageDropDownView(Context context) {
        super(context);
        initView();
    }

    public FilterCoachSelectionLanguageDropDownView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public FilterCoachSelectionLanguageDropDownView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        FilterCoachSelectionLanguageDropDownView.CustomAdapter adapter = new FilterCoachSelectionLanguageDropDownView.CustomAdapter(optionList,context);
    ...
    public void setClickListener(FilterCoachSelectionLanguageDropDownView.onClickInterface listener) {
    ...
    public class CustomAdapter extends ArrayAdapter<DataModel> implements OnClickListener {
        ...
        CustomAdapter(ArrayList<DataModel> data, Context context) {
            super(context, R.layout.filter_coach_language_spinner_item, data);
            this.dataSet = data;
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent) {
            ...
            FilterCoachSelectionLanguageDropDownView.CustomAdapter.ViewHolder viewHolder; // view lookup cache stored in tag
            if (convertView == null) {
                viewHolder = new FilterCoachSelectionLanguageDropDownView.CustomAdapter.ViewHolder();
                LayoutInflater inflater = LayoutInflater.from(getContext());
                convertView = inflater.inflate(R.layout.filter_coach_language_spinner_item, parent, false);
                viewHolder.txtName = convertView.findViewById(R.id.text_filter);

                convertView.setTag(viewHolder);
            } else {
                viewHolder = (FilterCoachSelectionLanguageDropDownView.CustomAdapter.ViewHolder) convertView.getTag();
            }
