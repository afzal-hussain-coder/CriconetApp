...
public class DropDownView extends OSLTextView implements View.OnClickListener, PopupWindow.OnDismissListener {
    ...
    private PopupWindow popupWindowSort(Context context) {
        ...
        popupWindow.setBackgroundDrawable(context.getDrawable(R.drawable.edit_text_bgg));
