...
import com.pb.criconet.activity.ProfileActivity;
...
//        });
        ...
        friends_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("user_id", userData.getNewUserModel().get(position).getUser_id());
...
//                        Timber.v(response);
                        ...
                        try {
                            ...
                            if (jsonObject.optString("api_text").equalsIgnoreCase("success")) {
                                ...
                                adapter = new Friends_Adapter(mContext, userData.getNewUserModel());
                                friends_list.setAdapter(adapter);
                                if (userData.getNewUserModel().size() == 0) {
                                    notfound.setVisibility(View.VISIBLE);
